  ...
  <div class="search2">
    ...
    <div class="search-history">
      <van-cell title="搜索历史" size="large">
        <van-icon slot="right-icon" color="#ccc" @click="clear" class-prefix="icon-font-18 iconfont icon-laji" style="line-height: inherit;" />
      </van-cell>
      <!--搜索历史内容 -->
    ...
    <div class="hot-search">
      <van-cell title="大家正在搜" size="large">
        <van-icon size="20px" slot="right-icon" color="#f60" name="fire" style="line-height: inherit;" />
      </van-cell>
      <!-- 热门搜索内容 -->
