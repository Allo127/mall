<template>
	...
	<div class="address-edit">
		...
		<!-- 编辑地址列表 -->
		<van-address-edit :area-list="areaList" show-postal show-delete show-set-default show-search-result :address-info="editAddressInfo"
	...
	export default {
		...
		methods: {
			...
			onSave(item) {
				...
				this.$api.address.editAddress(item).then(({
					data
				}) => {
					console.log(data)
				})
