<template>
	<div class="cart">
		...
		<div class="has-goods-order" v-else>
			...
			<div class="card-goods-list" v-for="(item,shopIdex) in cartInfoList" :key="item.id">
				...
				<div class="van-hairline--bottom store">
					<van-row>
						...
						<van-col>
							<van-image width="20" height="20" lazy-load src="http://t16img.yangkeduo.com/pdd_ims/77b95bab6fb53e3ac4cc370ba6a48d5a.jpg"
							 type="contain" />
						</van-col>
					...
					<div slot="default" class="order-item">
						<van-row type="flex" justify="space-between">
							...
							<van-col span="3" class="d-flex-c">
								<van-checkbox v-model="pros.isSelected" @click="selectSingle(item,pros)"></van-checkbox>
							</van-col>
							<!-- 订单商品图片 -->
							<van-col span="6">
								<van-image :src="pros.imgUrl" fit="contain" lazy-load show-loading class="order-img" />
							</van-col>
							<!-- 订单商品详细信息 -->
			...
			<!-- 提交订单 -->
			<van-submit-bar :loading="isLoading" safe-area-inset-bottom :price="1135" button-text="提交订单" @submit="onSubmit">
			...
			return {
				...
				cartInfoList: [{
						...
						productList: [{
								...
								imgUrl: "//t00img.yangkeduo.com/goods/images/2019-11-17/23af9e10ee30676329b7f9cb378a2e5b.jpeg?imageMogr2/sharpen/1%7CimageView2/2/w/312/q/70/format/webp",
								price: 19.9,
								num: 2
							},
							{
								...
								imgUrl: "//t00img.yangkeduo.com/goods/images/2019-11-03/bdbc5845840e48c831d475acfe53856a.jpeg?imageMogr2/sharpen/1%7CimageView2/2/w/312/q/70/format/webp",
								price: 29.9,
								num: 1
							}
						]
